...
namespace Noise
{
    ...
    public sealed class NoiseSocket : IDisposable
    {
        ...
        /// <summary>
        /// Flag to indicate the handshake is complete and we can now send messages.
        /// </summary>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (handshakeState.RemoteStaticPublicKey.Length > 0)
                {
                    RemoteStaticPublicKey = handshakeState.RemoteStaticPublicKey.ToArray();
                }
